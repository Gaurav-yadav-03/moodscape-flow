...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-dark shadow-soft hover:shadow-medium rounded-xl",
        ...
        outline: "border border-border bg-card/50 backdrop-blur-sm hover:bg-card hover:shadow-soft rounded-xl",
        ...
        gradient: "bg-gradient-warm text-white hover:opacity-90 shadow-medium hover:shadow-strong rounded-xl font-medium",
        glass: "glass-effect text-foreground hover:bg-white/30 backdrop-blur-md rounded-xl",
        mood: "rounded-full font-medium shadow-soft hover:shadow-medium transition-smooth hover:scale-105",
